...
# Set colors for the user interface
c.colors.completion.category.bg = dracula['background']
c.colors.completion.category.border.bottom = dracula['current-line']
c.colors.completion.category.border.top = dracula['current-line']
c.colors.completion.category.fg = dracula['green']
c.colors.completion.even.bg = dracula['background']
c.colors.completion.fg = dracula['foreground']
c.colors.completion.item.selected.bg = dracula['current-line']
c.colors.completion.item.selected.border.bottom = dracula['current-line']
c.colors.completion.item.selected.border.top = dracula['current-line']
...
c.colors.completion.scrollbar.bg = dracula['current-line']
...
c.colors.statusbar.command.private.fg = dracula['pink']
c.colors.statusbar.insert.bg = dracula['background']
c.colors.statusbar.insert.fg = dracula['green']
...
c.colors.statusbar.passthrough.fg = dracula['cyan']
c.colors.statusbar.private.bg = dracula['current-line']
c.colors.statusbar.private.fg = dracula['foreground']
c.colors.statusbar.progress.bg = dracula['pink']
...
c.colors.tabs.bar.bg = dracula['current-line']
c.colors.tabs.even.bg = dracula['current-line']
...
c.colors.tabs.odd.bg = dracula['current-line']
